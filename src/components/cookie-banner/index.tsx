...
export function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-0 z-10 flex h-auto w-full flex-col gap-3 rounded bg-tertiary px-5 py-3 text-sm font-medium shadow ring-1 ring-border sm:max-w-xl sm:flex-row sm:justify-between md:items-center">
